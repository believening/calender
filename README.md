...
应用支持将不同的历法设置为"主历法"，日历视图会根据主历法动态调整显示内容：

**支持的主历法：**
- 🌙 **农历** - 显示农历月份、日期、天干地支、生肖年
- 🏔️ **藏历** - 显示藏历月份、日期、绕迥纪年、五行生肖

**使用方法：**
1. 点击日历页面右上角的设置图标
2. 展开"主历法"选项
3. 选择想要使用的主历法（农历或藏历）
4. 日历网格会立即更新，显示对应历法的日期
5. 可以同时开启"显示农历"和"显示藏历"，在详情区域查看多个历法信息

**示例效果：**
- 选择"藏历"为主历法 → 日历网格显示藏历日期，年份卡片显示"第17绕迥 阳火马年"
- 选择"农历"为主历法 → 日历网格显示农历日期，年份卡片显示"丙午年 马年"
